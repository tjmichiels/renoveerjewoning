                ...
                <div className="mx-auto max-w-5xl pb-16">
                    <header>
                        ...
                        <p className="mt-3 text-gray-700 max-w-3xl">
                            Vul postcode en huisnummer in om te controleren of jouw woning in aanmerking komt.
                        </p>
                    </header>
                    ...
                    <section className="mt-8 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                        ...
                        <AnimatePresence>
                            {result?.energyLabel && (
                                <motion.div
                                    ...
                                    className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6 items-center"
                                >
                                    <motion.div
                                        initial={{ scale: 0.8 }}
                                        animate={{ scale: 1 }}
                                    ...
                                    <div>
                                        <h2 className="text-2xl font-semibold mb-2 text-gray-900">
                                            {result.shouldRenovate ? 'Renovatie aanbevolen' : 'Je woning scoort goed'}
                                        </h2>
                        ...
                        {result && !result.energyLabel && (
                            <pre className="mt-6 text-sm text-gray-900 bg-gray-50 p-4 rounded-2xl border border-gray-100">
